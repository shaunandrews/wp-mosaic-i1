...
import './MenuDocumentPicker.css';
import { Button } from '../Button/Button';
import { Icon } from '../Icon/Icon';

interface MenuDocumentPickerGroup {
  items: Array<{ id: string; label: string }>;
}

interface MenuDocumentPickerProps {
  children: React.ReactNode;
  groups: MenuDocumentPickerGroup[];
  selectedItemId?: string;
  onItemSelect?: (item: { id: string; label: string }) => void;
}

export interface MenuDocumentPickerHandle {
  open: (focusSearch?: boolean) => void;
}

export const MenuDocumentPicker = forwardRef<MenuDocumentPickerHandle, MenuDocumentPickerProps>(
  ({ children, groups, selectedItemId, onItemSelect }, ref) => {
    ...
    const getFilteredResults = (query: string): MenuDocumentPickerGroup[] => {
    ...
    const displayGroups: MenuDocumentPickerGroup[] = isSearching
